...
# load our YOLO object detector trained on COCO dataset (80 classes) and determine only the *output* layer
...
while True:
    ...
    for output in layerOutputs:
        ...
        for detection in output:
            ...
            if confidence > args["confidence"]:
                ...
                # actually returns the center (x, y)-coordinates of the bounding box followed by
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            ...
            print("Object detected" + str(text))
